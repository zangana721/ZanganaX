...
window.ityped.init(document.querySelector('.iTyped'), {
    strings: ["من گەشەپێدەری Front Endم", 'من حەزم لە فلاتەرە', 'من حەزم لە جاڤایە', 'من حەزم لە ئێج تی ئێم ئێلە', 'من حەزم لە سی ئێس ئێسە', 'من حەزم لە فیگمایە', 'من حەزم لە ئیلسترەیتەرە', ],
    loop: true
});